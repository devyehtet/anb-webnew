        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 py-16">
          ...
          <section className="mb-20">
            ...
            <p className="text-lg leading-relaxed text-gray-700 text-center max-w-3xl mx-auto">
              A New Burma is an organization dedicated to empowering
              Burma&apos;s marginalized communities through creative resistance,
              advocacy, and public engagement. Founded with a vision of a
              peaceful, inclusive, and democratic future for Burma, we work to
              amplify the voices of those affected by military oppression,
              conflict, and systemic injustice. Our core mission is to challenge
              impunity, promote human rights, and foster community-led solutions
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="bg-gray-100 rounded-sm p-8 border-2 shadow-[16px_16px_black] border-black">
                <h3 className="text-2xl font-bold text-black mb-4">
                  Creative Resistance
                </h3>
                <p className="text-lg leading-relaxed text-gray-700">
                  We use art, photography, and exhibitions to bring attention to
                  Burma&apos;s ongoing struggles, turning creativity into a tool
                  for advocacy and resistance. Through projects like the When We
                  See the Planes campaign, we highlight the impact of airstrikes
                  on civilians and call for an end to violence.
                </p>
              </div>
              <div className="bg-gray-100 rounded-lg p-8 border-2 shadow-[16px_16px_black] border-black">
                <h3 className="text-2xl font-bold text-black mb-4">
          ...
          <section className="text-center">
            ...
            <Link
              href="/donate"
              className="font-neutraface text-sm leading-5 font-bold border-2 hover:text-gray-800 px-5 py-1 hover:shadow-none transition-all ease-in-out text-gray-900 shadow-[8px_8px_black] border-black"
            >
              Go to Donate
            </Link>
          </section>
