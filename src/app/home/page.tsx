    ...
    <>
        ...
        <div className="flex md:flex-row flex-col gap-5 mb-28">
          ...
          <div className="md:w-1/3 w-full flex flex-col gap-8">
            <h3 className="flex justify-center items-center">
              <Image
                src={images.img_a_new_burma_logo_glitch}
                alt="A New Burma is"
                className="w-2/3 max-w-60"
              />
            </h3>
            <p className="leading-7 text-justify">
              A New Burma is a collective of young people who believe in working
              together toward a shared goal: building a future inclusive of all
              who would call Myanmar home. We have unique sets of skills and
              experiences in start-ups, marketing, politics, human rights, legal
              and economic activism, and across the social and creative
              industries. Many of us are exiled creatives ourselves, and through
              countless conversations with fellow creatives, we understand that
              life is more than just surviving; shared creativity and generous
              community help give existence identity and meaning. We believe
              Creative Resistance goes beyond refusing to be controlled, it is
              also about envisioning and building the New Free, together.
            </p>
          </div>
        </div>

        {/* Vision Section */}
        <div className="flex flex-col relative md:mx-15 lg:mx-20 pt-[90px] md:pt-[300px] pb-24 md:px-24 px-14">
          <Image
          ...
          <div className="flex flex-col md:flex-row gap-20">
            <Card text="Envisioning a New Burma where diversity, creativity, and freedom form the cornerstone of a resilient and vibrant society." />
            <Card text="Creating a future where Burma's youth and creative minds are at the forefront of a movement for peace, democracy, and inclusive development." />
          </div>
        </div>
      </section>
      ...
      <section className="relative pt-40">
        <Image
          ...
          className="z-[-1]"
        />
        <div className="flex flex-col md:mx-5 lg:mx-15 pt-[100px] md:pt-[250px] pb-16 px-15 lg:pb-24 lg:px-24">
          {/*<h2 className="text-[56px] z-50 text-white font-bold leading-7 mb-40">
            Programs
          </h2>*/}
          <Image
            src={images.img_programs_text}
            alt="programs"
            className="absolute top-[-50px] md:left-[170px] sm:left-[250px] w-11/12 max-w-[1198px]"
          />
          <EqualHeight>
